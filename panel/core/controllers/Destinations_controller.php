		...
		else
		{
			...
			foreach ($datas as $value)
			{
				...
				'<tr>
					...
					<td>' . $value['name'] . '</td>
					<td>
						<a data-action="delete" data-id="' . $value['id_destination'] . '"><i class="material-icons">delete</i><span>Eliminar</span></a>
						<a data-action="get" data-id="' . $value['id_destination'] . '"><i class="material-icons">menu</i><span>Detalles | Editar</span></a>
					</td>
				</tr>';
			}
