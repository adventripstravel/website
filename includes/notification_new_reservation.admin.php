...
<body style="box-sizing:border-box;margin:0;padding:0;width:100%;word-break:break-word;-webkit-font-smoothing:antialiased;">
    ...
    <div style="display:none;font-size:0;line-height:0;">
        Ingresa para ver la información de la nueva reservación.
    </div>
                            ...
                            <table cellpadding="0" cellspacing="0" role="presentation" width="100%">
                                <tr>
                                    <td align="center" class="px-sm-16" style="padding: 0 96px;">
                                        <h1 class="webfont h1" style="color: #FFFFFF; font-size: 36px; font-weight: 300; line-height: 100%; margin: 0;">Nueva reservación</h1>
                                    </td>
                                </tr>
                            </table>
