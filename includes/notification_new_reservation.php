...
<body style="box-sizing:border-box;margin:0;padding:0;width:100%;word-break:break-word;-webkit-font-smoothing:antialiased;">
    ...
    <div style="display:none;font-size:0;line-height:0;">
        Hola <?= $data['customer']['firstname'] ?> <?= $data['customer']['lastname'] ?>, tu reservación esta lista, puedes verla en el siguiente enlance.
    </div>
                ...
                <table class="container" cellpadding="0" cellspacing="0" role="presentation" width="600">
                    <tr>
                        <td bgcolor="#2a2760">
                            ...
                            <v:fill type="gradient" color="#2a2760" color2="#00C6FF" angle="90" />
                            ...
                            <table cellpadding="0" cellspacing="0" role="presentation" width="100%">
                                <tr>
                                    <td align="center" class="px-sm-16" style="padding: 0 96px;">
                                        <h1 class="webfont h1" style="color: #FFFFFF; font-size: 36px; font-weight: 300; line-height: 100%; margin: 0;">¡Gracias!</h1>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table cellpadding="0" cellspacing="0" role="presentation" width="100%">
                                <tr>
                                    <td class="col px-sm-16" align="center" width="100%" style="padding: 0 64px;">
                                        <p style="color: #888888; font-size: 16px; line-height: 24px; margin: 0;">Hola <?= $data['customer']['firstname'] ?> <?= $data['customer']['lastname'] ?>, se ha completado correctamente tu reservación. Puedes verla online en el siguiente enlance.</p>
                                        ...
                                        <table cellpadding="0" cellspacing="0" role="presentation" style="margin-bottom: 20px">
                                            <tr>
                                                <td class="webfont" bgcolor="#2a2760" style="border-radius: 3px; transition: all 0.3s ease-in-out 0s; mso-padding-alt: 6px 32px 12px;">
                                                    <a href="https://adventrips.com/ticket/<?= $data['folio'] ?>" style="color: #FFFFFF; display: inline-block; font-size: 14px; font-weight: 700; padding: 12px 32px; text-decoration: none;">Ver ticket online</a>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
